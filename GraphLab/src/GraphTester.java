...
public class GraphTester {
	...
	@Test
	public void test07() {
		// commented code are the original code of 
		// of the tester, the the line of code 
		// below it is the code I added to accommodate
		// the need for undirected but not directed 
